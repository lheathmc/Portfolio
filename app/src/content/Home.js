...
const contentArray = [
    ...
    img: "./images/illustrations/OurMcDonaldFamilyTree2.jpg"
    },
    {
    ...
    img: "./images/illustrations/BotSwing2-Painting.jpg"
    },
];
...
const Home = () => {
  return (
    <Box>
        <Box sx={{padding:10, backgroundImage:"url('./images/illustrations/Nature.jpg')"}} backgroundColor="#efefef" display="flex" justifyContent={"center"} flexDirection="column">
